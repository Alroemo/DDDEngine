...
public class Cube {
    ...
    public Cube(double x, double y, double z, double width, double length, double height, Color c, boolean rot)
    {
    ...
    void UpdateDirection(double toX, double toY, boolean rot)
    {

        //double xdif = toX - (x + width/2) + 0.00001;
        //double ydif = toY - (y + length/2) + 0.00001;
        double xdif = toX - (x + width/2) + 0.0000;
        double ydif = toY - (y + length/2) + 0.0000;
